...
2 +
    ...
    // если в prompt пользователь ввел число больше нуля.Если был введен ноль, выводи в консоль строку "Это ноль".
...
// if ()
// const examination = link.includes('/');
// console.log(link);
...
7 +
    ...
    // 'https://somesite.com/about' ? 'my-site' : '/';
    // console.log(link);
...
// const userLogin = prompt("Запиши логин");
